# Project State: Smart-IV

## 🚀 Active Context
- **Last User Activity**: Setting up collaborative syncing between Hrishi and Akash.
- **Current Mode**: Synchronization Setup.
- **Branch Strategy**: `hrishi-dev` (Hrishi) and `akash-dev` (Akash).
